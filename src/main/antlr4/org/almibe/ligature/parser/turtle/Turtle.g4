...
string
  : START_SINGLE_QUOTE STRING_CONTENT_SINGLE_QUOTE? CLOSE_SINGLE_QUOTE
  | START_DOUBLE_QUOTE STRING_CONTENT_DOUBLE_QUOTE? CLOSE_DOUBLE_QUOTE
  | START_TRIPLE_SINGLE_QUOTE STRING_CONTENT_TRIPLE_SINGLE_QUOTE? CLOSE_TRIPLE_SINGLE_QUOTE
  | START_TRIPLE_DOUBLE_QUOTE STRING_CONTENT_TRIPLE_DOUBLE_QUOTE? CLOSE_TRIPLE_DOUBLE_QUOTE
;
