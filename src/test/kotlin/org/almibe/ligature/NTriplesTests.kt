...
//        NTripleLexer lexer = new NTripleLexer(cs);
//        CommonTokenStream tokens = new CommonTokenStream(lexer);
//        NTripleParser parser = new NTripleParser(tokens);
//        ParseTree tree = parser.add(); // parse; start at prog <label id="code.tour.main.6"/>
//    }
//
